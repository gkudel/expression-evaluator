...
{
    internal class CosExpression : UnaryExpression
    {
        #region Constructor
        ...
        #region Properties
        internal override string Name { get { return "CosExpression"; } }
        ...
        internal override Expression Evaluate(Expression[] values, out bool evaluted)
        {
            ...
            {
                evaluted = true;
                return new ConstExpression(Math.Cos(values[0].NumericValue.Value));
            }
            return null;
        }
        #endregion Evaluate
