...
{
    internal class SinhExpression : UnaryExpression
    {
        #region Constructor
        ...
        #region Properties
        internal override string Name { get { return "SinhExpression"; } }
        ...
        internal override Expression Evaluate(Expression[] values, out bool evaluated)
        {
            ...
            {
                evaluated = true;
                return new ConstExpression(Math.Sinh(values[0].NumericValue.Value));
            }
            return null;
        }
        #endregion Evaluate
