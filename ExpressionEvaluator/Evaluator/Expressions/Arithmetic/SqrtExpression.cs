...
{
    public class SqrtExpression : UnaryExpression
    {
        #region Constructor
        ...
        #region Properties
        public override string Name { get { return "SqrtExpression"; } }
        ...
        internal override Expression[] Evaluate(Expression[] values, out bool evaluated)
        {
            ...
            {
                evaluated = true;
                return new Expression[] { new ConstExpression(Math.Sqrt(values[0].NumericValue.Value)) };
            }
            return null;
        }
        #endregion Evaluate
