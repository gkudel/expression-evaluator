...
{
    internal class MinExpression : BinaryExpression
    {
        #region Constructor
        ...
        #region Properties
        internal override string Name { get { return "MinExpression"; } }
        ...
        internal override Expression[] Evaluate(Expression[] values, out bool evaluated)
        {
            ...
            {
                evaluated = true;
                return new Expression[] { new ConstExpression(Math.Min(values[0].NumericValue.Value, values[1].NumericValue.Value)) };
            }
            return null;
        }
        #endregion Evaluate
